...
|---|---:|---:|---:|---:|---:|---|
| N | 1020 | 0.925 | 0.932 | 0.915 | 0.00 | ✅ ≥0.90 |
| SR | 1020 | 0.001 | 0.002 | 0.000 | 0.00 | — |

## Fim-a-fim (k=8, held-out)

| arm | k | n | EM | retr top-1 | EM se retr ok | tok prompt | s/item | portão |
|---|---:|---:|---:|---:|---:|---:|---:|---|
| N | 8 | 1024 | 0.899 | 0.931 | 0.964 | 80 | 0.08 | ✅ ≥0.85 |
| SR | 8 | 1024 | 0.171 | 0.503 | 0.320 | 86 | 0.05 | — |

## Veredito

- Extração (portão 1, ≥0.90): ✅ passou (EM=0.925).
- Critério de morte (teto V1 0.59): não acionado (EM 0.925 ≫ 0.59) — a vantagem do substrato pré-treinado é real.
- Ablação (pesos aleatórios): EM=0.001 — desabou (✅ CARTA §3.1).
- Fim-a-fim @ k=8: ✅ passou (EM=0.899).
